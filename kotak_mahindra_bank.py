...
table=soup.find_all("table",class_="table_1 table table-bordered")
...
int_rate_df=pd.DataFrame(LIST_OF_INTEREST_RATES,columns=['bank_name','tenure','gen_rate','annualised_gen_rate','sr_rate','annualised_sr_rate','super_senior_rate','annualised_super_sr_rate','threshold_amt'])
